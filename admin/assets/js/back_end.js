...
jQuery(window).on('load', function(){
	...
	if ( ihcCurrentUrl.indexOf( 'admin.php?page=membership_manage&tab=add_edit_taxes' ) !== -1 ){
					// Taxes - add edit
	...
	if ( ihcCurrentUrl.indexOf( 'admin.php?page=membership_manage&tab=add_new_order' ) !== -1 ){
			// orders - add new
	...
	if ( ihcCurrentUrl.indexOf( 'admin.php?page=membership_manage&tab=coupons&subtab=multiple_coupons' ) !== -1 ||
				ihcCurrentUrl.indexOf( 'admin.php?page=membership_manage&tab=coupons&subtab=add_edit' ) !== -1
	){
	...
	if ( ihcCurrentUrl.indexOf( 'admin.php?page=membership_manage&tab=general&subtab=public_workflow' ) !== -1 ){
	...
	if ( ihcCurrentUrl.indexOf( 'admin.php?page=membership_manage&tab=block_url' ) !== -1 ){
	...
	if ( ihcCurrentUrl.indexOf( 'admin.php?page=membership_manage&tab=general&subtab=captcha' ) !== -1 ){
			// general settings
	...
	if ( ihcCurrentUrl.indexOf( 'admin.php?page=membership_manage&tab=levels' ) !== -1 ){
			// levels
	...
	if ( ihcCurrentUrl.indexOf( 'admin.php?page=membership_manage&tab=account_page_menu' ) !== -1 ){
	...
	if ( ihcCurrentUrl.indexOf( 'admin.php?page=membership_manage&tab=levels&edit_level' ) !== -1 ||
 				ihcCurrentUrl.indexOf( 'admin.php?page=membership_manage&tab=levels&new_level=true' ) !== -1
	){
			// levels - add/edit
	...
	if ( ihcCurrentUrl.indexOf( 'admin.php?page=membership_manage&tab=order-edit' ) !== -1 ){
			jQuery('#created_date_ihc').datepicker({
					dateFormat 		: 'yy-mm-dd',
					onSelect			: function(datetext){
							var d = new Date();
	...
	if ( ihcCurrentUrl.indexOf( 'admin.php?page=membership_manage&tab=orders' ) !== -1 ){
	...
	if ( ihcCurrentUrl.indexOf( 'admin.php?page=membership_manage&tab=listing_users' ) !== -1 ){
			// Members Directory
			ihcPreviewUList();
	}

	if ( ihcCurrentUrl.indexOf( 'page=membership_manage&tab=locker&subtab=add_new' ) !== -1 ){
			// Locker - add/edit
			ihcLockerPreview();
	...
	if ( ihcCurrentUrl.indexOf( 'admin.php?page=membership_manage&tab=locker' ) !== -1 ){
			// Locker - list all
	...
	if ( ihcCurrentUrl.indexOf( 'admin.php?page=membership_manage&tab=login' ) !== -1 ){
			// Login
			ihcLoginPreview();
	}

	if ( ihcCurrentUrl.indexOf( 'admin.php?page=membership_manage&tab=notifications&edit_notification=' ) !== -1 ||
				ihcCurrentUrl.indexOf( 'admin.php?page=membership_manage&tab=notifications&add_notification=true' ) !== -1
 	){
	...
	if ( ihcCurrentUrl.indexOf( 'admin.php?page=membership_manage&tab=notifications&add_notification=true' ) !== -1 ){
			// notifications - add
			ihcChangeNotificationTemplate();
	}
	if ( ihcCurrentUrl.indexOf( 'admin.php?page=membership_manage&tab=notifications' ) !== -1 ){
			// notifications - list
				ihcNotificationLevelOnlyFor();
	...
	if ( ihcCurrentUrl.indexOf( 'admin.php?page=membership_manage&tab=register' ) !== -1 ){
			// register
	...
	if ( ihcCurrentUrl.indexOf( 'admin.php?page=membership_manage&tab=subscription_plan' ) !== -1 ){
			// Subscription Plan
			ihcPreviewSelectLevels();
	}

	if ( ihcCurrentUrl.indexOf( 'admin.php?page=membership_manage&tab=user-details' ) !== -1 ){
			// User Details
	...
	if ( ihcCurrentUrl.indexOf( 'admin.php?page=membership_manage&tab=users&ihc-edit-user' ) !== -1 ){
	...
	if ( ihcCurrentUrl.indexOf( 'admin.php?page=membership_manage&tab=users' ) !== -1 ){
	...
	if ( ihcCurrentUrl.indexOf( 'admin.php?page=membership_manage&tab=woo_product_custom_prices&subtab=add_edit' ) !== -1 ){
	...
	if ( ihcCurrentUrl.indexOf( 'admin.php?page=membership_manage&tab=account_page' ) !== -1 ){
			// account page
	...
	if ( ( ihcCurrentUrl.indexOf( 'admin.php?page=membership_manage&tab=dashboard' ) !== -1 )
			|| ( ihcCurrentUrl.indexOf( 'admin.php?page=membership_manage' ) !== -1 && ihcCurrentUrl.indexOf( 'admin.php?page=membership_manage&tab' ) === -1 )
	){
			// dashboard
	...
	if ( ihcCurrentUrl.indexOf( 'admin.php?page=membership_manage&tab=help' ) !== -1 ){
			// help
	...
	if ( ihcCurrentUrl.indexOf( 'admin.php?page=membership_manage&tab=invoices' ) !== -1 ){
	...
	if ( ihcCurrentUrl.indexOf( 'page=membership_manage&tab=opt_in' ) !== -1 ){
	...
	if ( ihcCurrentUrl.indexOf( 'page=membership_manage&tab=prorate_add_edit' ) !== -1 ){
	...
	if ( ihcCurrentUrl.indexOf( 'page=membership_manage&tab=prorate_subscription' ) !== -1 ){
