...
function get_wpml_original_text($translated_text, $context = 'admin_texts_ihc_user_fields') {
    global $wpdb;
...
<div class="ihc-stuffbox">
    ...
    <div class="inside">
        <div class="ihc-js-print-page ihc-print-buttton-wrapper"><i
                class="fa-ihc fa-print-ihc"></i> <?php esc_html_e('Print', 'ihc'); ?></div>
            ...
            <div class="ihc-admin-user-details-wrapper">
                <div class="ihc-admin-left-side">
                    ...
                    <div class="ihc-admin-user-edit-profile">
                        <a href="<?php echo admin_url('admin.php?page=ihc_manage&tab=users&ihc-edit-user=' . esc_attr($uid)); ?>"
                    ...
                    <div class="ihc-admin-user-profile-status">
                        ...
                        <?php if (!empty($data['user_roles'])): ?>
                            <?php foreach ($data['user_roles'] as $roleKey => $roleIndex): ?>
                                ...
                                <div
                                    class="<?php echo esc_attr($class); ?>"><?php echo esc_html($availableRoles[$roleKey]); ?></div>
                            <?php endforeach; ?>
                        <?php endif; ?>
                    </div>
                    ...
                    <?php if (get_option('ihc_individual_page_enabled') && !empty($data['ihc_individual_page'])) : ?>
                        <div class="ihc-admin-user-profile-status">
                            ...
                            <div class="level-type-list ihc_small_yellow_button level-type-list-st"><a
                                    href="<?php echo esc_url($url); ?>"
                                    target="_blank"><?php esc_html_e('Individual Page', 'ihc'); ?></a></div>
                        </div>
                    <?php endif; ?>
                </div>
                    ...
                    <div class="ihc-admin-user-data">
                        <table>
                            ...
                            <tr>
                                ...
                                <td class="ihc-admin-user-data-content"><a
                                        href="mailto:<?php echo esc_url($data['user_email']); ?>"><?php
                        ...
                        <table class="ihc-js-user-extra-fields ihc-display-none">
                            ...
                            <?php if ($userFields): ?>
                                ...
                                <?php foreach ($userFields as $userField): ?>
                                    ...
                                    elseif($userField["conditional_logic_corresp_field"] != "" && $userField ["conditional_logic_corresp_field_value"] != get_wpml_original_text($data[$userField["conditional_logic_corresp_field"]]))
                                    {
                                        continue;
                                    }
                                    $showMore = true;
                                        ...
                                        <td class="ihc-admin-user-data-content">
                                            ...
                                            switch ($userField['type']) {
                                                ...
                                                case 'ihc_state':
                                                    ...
                                                    break;
                                                case 'select':
                                                    $original_text = get_wpml_original_text($data[$slug]);
                                                    if (in_array($original_text, $userField['values'])){
                                                        echo esc_html($data[$slug]);
                                                    }
                                                    break;
                                                case 'file' :
                                                    ...
                                                    echo "<a href = '$url' target = '_blank'>$media_id</a></p>";
                                                    break;
                                                default:
                        ...
                        <?php if ($showMore): ?>
                            <div
                                class="ihc-pointer ihc-js-show-more ihc-user-details-showmore-fields iump-second-button"><?php esc_html_e('Show More', 'ihc'); ?></div>
                        <?php endif; ?>
                ...
                <?php if (!empty($data['subscriptions'])): ?>
                    <div class="ihc-admin-user-data-list ihc-admin-user-data-list-st">
                        ...
                        <div class="ihc-manage-user-expire-wrapper-edit">
                            <a href="<?php echo admin_url('admin.php?page=ihc_manage&tab=users&ihc-edit-user=' . esc_attr($uid) . '#ihc_membeship_select_wrapper'); ?>"
                               target="_blank">
                ...
                <?php if (!empty($data['orders'])): ?>
                    ...
                    <div class="ihc-admin-user-data-list">
                        ...
                        <a class="ihc-user-details-showmore-link"
                           href="<?php echo admin_url('admin.php?page=ihc_manage&tab=orders&uid=' . $uid); ?>"
                ...
                <?php if (!empty($data['notification_logs'])): ?>
                    ...
                    <div class="ihc-admin-user-data-list">
                        ...
                        <table class="wp-list-table widefat fixed tags">
                            ...
                            <?php foreach ($data['notification_logs'] as $notification): ?>
                                <tr>
                                    ...
                                    <td>
                                        <div
                                            class="ihc-userdetails-not-sub"><?php echo esc_ump_content($notification->subject); ?></div>
                        ...
                        <a class="ihc-user-details-showmore-link"
                           href="<?php echo admin_url('admin.php?page=ihc_manage&tab=notification-logs&uid=' . $uid); ?>"
                           target="_blank"><?php esc_html_e('Show more', 'ihc'); ?></a>
                    </div>
                <?php endif; ?>
