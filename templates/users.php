...
wp_enqueue_script( 'back_end_js', MDAN_URI . 'admin/assets/js/back_end.js', ['jquery'], 12.9 );
...
if (isset($_REQUEST['ihc-edit-user']) || isset($_REQUEST['ihc-new-user'])){
    ...
    <div class="iump-wrapper">
        <div id="col-right" class="ihc-admin-listing-users">
            ...
            echo esc_url($url);?>" class="indeed-add-new-like-wp">
            ...
            wp_enqueue_style( 'ihcmultiselect', IHCCUSTOM_URL . 'admin/assets/css/jquery.multiselect.css');
            wp_enqueue_script( 'ihcmultiselectfunctions', IHCCUSTOM_URL . 'admin/assets/js/jquery.multiselect.js', ['jquery'], '12.9' );

            // css
            wp_enqueue_style( 'ihcdatabse', IHCCUSTOM_URL . 'admin/assets/css/datatables/datatables.min.css');
            wp_enqueue_style( 'ihcdatabse-buttons', IHCCUSTOM_URL . 'admin/assets/css/datatables/buttons.dataTables.min.css');

            // js
            wp_enqueue_script( 'ihcdatabse', IHCCUSTOM_URL . 'admin/assets/js/datatables/datatables.min.js', ['jquery'], '12.9' );
            wp_enqueue_script( 'ihcdatabse-buttons', IHCCUSTOM_URL . 'admin/assets/js/datatables/dataTables.buttons.min.js', ['jquery'], '12.9' );
            wp_enqueue_script( 'ihcdatabse-colvis', IHCCUSTOM_URL . 'admin/assets/js/datatables/buttons.colVis.min.js', ['jquery'], '12.9' );
            // iump datatable functions
            wp_register_script( 'ihc-table', IHCCUSTOM_URL . 'admin/assets/js/table.js', ['jquery'], '12.9' );
